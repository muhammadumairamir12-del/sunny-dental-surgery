...
(function () {
  ...
  <div id="quick-booking-modal" class="booking-modal-overlay" aria-hidden="true" role="dialog">
    <div class="booking-modal">
      ...
      <p>Fill out this form to generate your formatted WhatsApp message directly. All fields marked with * are required.</p>
      <form id="quickBookingForm">
        <div class="form-row">
          <div class="form-group">
            <label for="qbName">First Name <span>*</span></label>
            <input type="text" id="qbName" class="form-input" placeholder="Your Name" required>
          </div>
          <div class="form-group">
            <label for="qbSurname">Last Name / Surname <span>*</span></label>
            <input type="text" id="qbSurname" class="form-input" placeholder="Your Surname" required>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
            <label for="qbMobile">Mobile Number <span>*</span></label>
            <input type="tel" id="qbMobile" class="form-input" placeholder="03xx xxxxxxx" required>
          </div>
          <div class="form-group">
            <label for="qbEmail">Email Address</label>
            <input type="email" id="qbEmail" class="form-input" placeholder="your@email.com">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="qbTime">Preferred Date &amp; Time <span>*</span></label>
            <input type="text" id="qbTime" class="form-input" placeholder="e.g. Monday 10:00 AM" required>
          </div>
        </div>
        <button type="submit" class="btn btn-wa w-full" style="justify-content:center;margin-top:16px;">
